...
def parse_args():
    ...
    parser.add_argument(
        '--sparsity',
        type=str,
        choices=['none', 'zdy_light', 'low', 'medium', 'high', 'very_high',
                 'balanced', 'zdy_focus'],
        help='Filter by sparsity preset (NVAE/DIVA: none/zdy_light/low/medium/high/very_high, '
             'AugmentedDANN: none/low/medium/high/balanced/zdy_focus)'
    )
    parser.add_argument(
        '--classifier',
        type=str,
